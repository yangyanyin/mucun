<template>
  <div>
    ...
    <div class="investment margin-t-80 pc-max-width animation-show">
      ...
      <p>创业投资移民是新加坡全球护照交流中心为客户量身定制的专属投资移民方案，是目前新加坡移民法律下最佳的移民方式选择。申请人通过投资创办新加坡公司，获取新加坡政府颁发的创业准证(Entrepass)，当公司运营至满足新加坡政府的指定要求后，便可向新加坡移民局（ICA）申请绿卡，从而移民新加坡，之后可申请全家入籍新加坡，免签超过全球170个国家，为地表名副其实的最强护照。</p>
          ...
          <div class="tab-centenr clearfix">
            ...
            <ul class="right company" v-if="showTabBtn===2">
              ...
              <li>
                ...
                <br />b.持有国家级知识产权机构批准的专利/知识产权c.与新加坡科技研究局认可的科研机构或新加坡高校有研发合作d.是获新加坡标新局、新加坡国家研发基金会等机构支持的科技创新型企业
              </li>
              <li>投资500万人民币入股新公司</li>
      ...
      <div class="content pc-max-width clearfix animation-show">
        ...
        <div class="list left">
          <div class="info brick-item">
            ...
            <strong>批复率高</strong>
            <p>新加坡全球护照交流中心聘前移民官预评申请人情况，不浪费时间，批准率高。</p>
          </div>
        </div>
        <div class="list left">
          <div class="info brick-item">
    ...
    <div class="process margin-t-80 pc-max-width">
      ...
      <ul class="animation-show">
        ...
        <li>
          <i>03</i>
          <p>
            新加坡全球护照交流中心递交申请，按照合同履行各自的权利和义务。
          </p>
        </li>
        <li>
          <i>04</i>
