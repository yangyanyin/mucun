  ...
  <div class="singapore-office">
    ...
    <div class="plan">
      <div class="bn">
        ...
        <span>根据《新加坡所得税法》的第134章，新加坡以下几项税收优惠计划适用于在新加坡设立家族办公室管理的对应基金：</span>
...
.plan {
  ...
  .bn {
    ...
    text-align: center;
    color: #fff;
    background: url('../../../assets/images/singapore/singapore-office-icon10.jpg') no-repeat top center;
    h3 {
      padding: 90px 0 5px;
      font-size: 24px;
    }
