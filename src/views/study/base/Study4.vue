<template>
  <div class="preschool">
    <div class="pc-max-width">
      <div class="content clearfix margin-t-80 animation-show">
        <div class="list left img">
          <img
            src="../../../assets/images/overseas-study/preschool-education-icon2.jpg"
          />
        </div>
        <div class="list text right">
          <div class="t">
            <strong>新加坡学前教育</strong>
            <p>新加坡学前教育被公认为全球最优质的学前教育体系之一，它沿袭了英国的幼儿教育体系；同时新加坡政府对幼儿教育的发展采用监管、扶持的机制，鼓励民间私立自行运营发展幼儿教育。新加坡十分重视学生从小进行基本的价值观和道德观教育、培养良好的个性品质，例如辨别是非对错的能力；愿意与他人沟通、分享；具有好奇心、勇于探索的精神；培养健康的生活态度以及学生的独立性、自理能力等。</p>
            <p>新加坡为3至6周岁的儿童提供三年的“寓教于乐”学前教育，每个年级的日常课程包含了：开发语言和阅读能力、基本算术能力、科学常识、创新能力、实践技能以及音乐欣赏和室外游戏等。让孩子每天有频繁的机会探索和选择，注重孩子的智力开发，鼓励幼儿在游戏中学习知识；注重培养学生的创造性，培养他们的社会责任感等。教授课程通常以英语和第二语言进行教学，使孩子各方面技能都得到均衡发展。</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="advantage margin-t-80">
      <h3 class="study-title">选择新加坡学前教育的优势</h3>
    ...
    <div class="margin-t-80 select-we pc-max-width"> 
      <h3 class="study-title">为什么选择我们</h3>
      <ul class="clearfix">
        <li>
      ...
      <p>侨水资本-Waterland Capital专注于为高净值人群子女提供一站式专属定制的VIP留学方案，依托我司高端资源与各大院校保持良好合作关系，我们经验丰富的专业规划团队将量体裁衣规划与推荐最佳院校，从出入境手续的办理开始，到登陆安家、子女入学以及后期家长移民提供一站式细致周到的服务安排，因为我们身在新加坡所以更懂新加坡，让您即便在国外也有宾至如归的感觉。</p>
      <span>侨水资本-Waterland Capital愿在助您孩子成为精英的成长道路上，做您值得信赖的海外朋友。</span>
    </div>
    ...
    return {
      listData: [
        ...
        },
        {
          ...
          text: "启蒙阶段培养孩子的创造力、想象力以及动手能力",
        },
        {
          icon: require("../../../assets/images/overseas-study/preschool-education-icon6.png"),
          text: "培养孩子良好的习惯、塑造孩子的社会意识",
        },
        {
        ...
        },
        {
          ...
          text: "免AEIS考试直接升入小学一年级",
        },
        {
          icon: require("../../../assets/images/overseas-study/preschool-education-icon9.png"),
          text: "让孩子早在童年阶段就轻松掌握英语",
        },
      ],
      schoolData: {
        title: "推荐学前机构",
        list: [
          ...
          {
            icon: require('../../../assets/images/overseas-study/school/odyssey-logo.png'),
            name: "Odyssey 幼儿园",
            url: "/Odyssey",
          },
          {
            icon: require("../../../assets/images/overseas-study/school/pat-s-logo.png"),
            name: "Pat’s 校舍",
            url: "/pat-s",
          },
          {
            icon: require('../../../assets/images/overseas-study/school/whitelodgeIogo-logo.png'),
            name: "Whitelogde 幼儿园",
            url: "/white-lodge",
          }
        ]
