        ...
        <div class="pc-max-width">
            <div class="content clearfix margin-t-80 animation-show">
                <div class="list left img">
                    <img src="../../../assets/images/overseas-study/preschool-education-icon1.jpg" />
                </div>
                <div class="list text right">
                    <div class="t">
                        <strong>NO.1</strong>
                        <p>新加坡学前教育被公认为世界上最好的学前教育体系之一，沿袭了英国的幼儿教育体系，新加坡政府对学前教育的发展采用监管、扶持的机制，鼓励民间私立自行运营发展幼儿教育</p>
                    </div>
                </div>
            </div>
            ...
            <div class="content clearfix margin-t-80 animation-show">
                <div class="list img right">
                    <img src="../../../assets/images/overseas-study/preschool-education-icon2.jpg" />
                </div>
            ...
            <div class="content clearfix margin-t-80 animation-show">
                <div class="list left img">
                    <img src="../../../assets/images/overseas-study/preschool-education-icon3.jpg" />
                </div>
                <div class="list text right">
                    <div class="t">
                        <strong>NO.3</strong>
                        <p>新加坡的教育十分注重从小进行基本的价值观和道德观的教育、培养良好个性品质的人格：辨别是非对错；愿意与他人沟通与分享；具有好奇心及勇于探索；建立健康的生活以及培养良好的习惯；掌握独立生活的自理能力。</p>
                    </div>
                </div>
            </div>
        </div>
