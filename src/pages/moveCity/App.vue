<template>
    <Layout>  
        ...
        <div class="investment margin-t-80 pc-max-width animation-show">
			...
			<p>创业投资移民是儒商资管为客户量身定制的专属投资移民方案，是目前新加坡移民法律下最佳的移民方式选择。申请人通过投资创办新加坡公司，获取新加坡政府颁发的创业准证(Entrepass)，当公司运营至满足新加坡政府的指定要求后，便可向新加坡移民局（ICA）申请绿卡，从而移民新加坡，之后可申请全家入籍新加坡，免签超过全球170个国家，为地表名副其实的最强护照。</p>
        ...
        <div class="margin-t-80 crowd">
            ...
            <div class="content pc-max-width clearfix animation-show">
            	...
            	<div class="list left">
            		...
            		<strong>通过儒商资管<br />评估测试</strong>
            	</div>
            	<div class="list left">
            		<img src="../../assets/images/city/crowd-icon3.png" />
            		<strong>想快速获取新加坡<br />绿卡身份</strong>
            	</div>
            	<div class="list left">
            		<img src="../../assets/images/city/crowd-icon4.png" />
            		<strong>常居国内但是想移民<br />新加坡的精英</strong>
            	</div>
            </div>
        </div>
        ...
        <div class="process margin-t-80 pc-max-width">
            ...
            <ul class="animation-show">
            	...
            	<li>
            		<i>02</i>
					<p>若有把握办理，儒商资管<br />开始受理，签订服务协议</p>
            	</li>
            	<li>
            		<i>03</i>
            		<p>儒商资管递交申请，按照<br />合同履行各自的权利和义务。</p>
            	</li>
            	<li>
            		<i>04</i>
            		<p>获得EP批准，按照已签订<br />的服务合同分阶段付费。</p>
            	</li>
            	<li>
            		<i>05</i>
            		<p>为申请人规划绿卡<br />申请最佳路线。<br /></p>
            	</li>
            </ul>
        </div>
