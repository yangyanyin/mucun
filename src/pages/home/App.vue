    ...
    <template v-else>
      ...
      <div class="choose-us pc-max-width margin-t-80">
        ...
        <div class="content">
          ...
          <div class="low-price animation-show">
            <img src="../../assets/images/index/low-price.jpg" />
          </div>
      ...
      <div class="country-passport pc-max-width margin-t-80">
        ...
        <div class="content clearfix animation-show">
          <div class="list left">
            <span>
              <img src="../../assets/images/index/passport-icon1.png" />
            </span>
            <h3>非全球征税</h3>
          ...
          <div class="list left">
            <span>
              <img src="../../assets/images/index/passport-icon2.png" />
            </span>
            <h3>全球通行</h3>
          ...
          <div class="list left">
            <span>
              <img src="../../assets/images/index/passport-icon3.png" />
            </span>
            <h3>轻松入籍</h3>
          ...
          <div class="list left">
            <span>
              <img src="../../assets/images/index/passport-icon4.png" />
            </span>
            <h3>方式多样</h3>
          ...
          <div class="list left">
            <span>
              <img src="../../assets/images/index/passport-icon5.png" />
            </span>
            <h3>入读国际学校</h3>
      ...
      <div class="index-about pc-max-width margin-t-80">
        ...
        <div class="content animation-show">
          ...
          <div class="info">
            ...
            <p
              class="p1"
            >新加坡全球护照交流中心作为儒商文化的忠实信仰者，十年深耕新加坡，我们专注于为亚洲区域范围内的成功企业家提供第二居住和公民身份的服务，使个人或家庭成为全球公民。这是我们团队通过专业的一对一定制服务体验实现的，客户通过我们简化了成为全球公民的复杂性，并通过和相关机构保持长期稳定关系，可满足亚洲区域企业家对全球公民的需求。</p>
            <p>新加坡全球护照交流中心立足狮城，放眼亚洲，专业服务亚洲企业成功精英。</p>
          </div>
        </div>
      </div>
